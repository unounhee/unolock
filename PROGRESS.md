...
## 바로 다음 할 일 (⑦: RLS 권한 규칙 = 정보 비대칭)
지금 11개 표는 전부 "아무도 못 봄"으로 잠겨 있음. 로그인한 사람이 자기 데이터를 보게
권한 규칙을 하나씩 연다. 첫 규칙: "로그인한 사용자는 자기 profiles 줄을 읽을 수 있다".
- 그다음: 출제자가 자기 학원/반/교재 보기, 학부모는 통과 결과만 보기(정보 비대칭).
