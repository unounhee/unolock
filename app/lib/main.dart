...
void main() {
  runApp(const LockTestApp());
}

class LockTestApp extends StatelessWidget {
  const LockTestApp({super.key});
...
class _LockHomePageState extends State<LockHomePage> {
  // MainActivity.kt 의 통로 이름과 똑같아야 함
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('UnoLock 잠금 실험'),
      ),
      body: Center(
        child: Padding(
